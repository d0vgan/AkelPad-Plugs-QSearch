...
static void qsShowFindResults_LogOutput_Init(const wchar_t* cszFindWhat, tDynamicBuffer* pBuf)
{
    wchar_t* pszText;
    ...
    if ( !tDynamicBuffer_Reserve(pBuf, nBytesToAllocate) )
...
static void qsStoreResultCallback(HWND hWndEdit, const AECHARRANGE* pcrFound, const wchar_t* cszFindResult, tDynamicBuffer* pBuf, tShowFindResults_AddOccurrence pfnAddOccurrence)
{
    ...
    pfnAddOccurrence( (const wchar_t *) pBuf->ptr );
}
...
void qsearchDoSearchText(HWND hEdit, DWORD dwParams, const DWORD dwOptFlags[], tQSFindAll* pFindAll)
{
    ...
    else // !g_Plugin.bOldWindows
    {
        ...
        else // pFindAll
        {
            ...
            pFindAll->ShowFindResults.pfnInit(szFindTextW, &pFindAll->buf);
