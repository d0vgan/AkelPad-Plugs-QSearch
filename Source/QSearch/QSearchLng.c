...
const char* szFindAllPopupMenuA[INLNG_COUNT][QS_FINDALL_TOTAL] = {
    ...
    /* rus */
    {
        ...
        "\xC2\xFB\xE2\xEE\xE4: \xCC\xE8\xED\xE8\xEC\xE0\xEB\xFC\xED\xFB\xE9\x20\xF0\xE5\xE6\xE8\xEC",
    ...
    /* ukr */
    {
        ...
        "\xC2\xE8\xE2\xB3\xE4: \xCC\xB3\xED\xB3\xEC\xE0\xEB\xFC\xED\xE8\xE9\x20\xF0\xE5\xE6\xE8\xEC",
...
const wchar_t* szFindAllPopupMenuW[INLNG_COUNT][QS_FINDALL_TOTAL] = {
    ...
    /* rus */
    {
        ...
        L"\x0412\x044B\x0432\x043E\x0434: \x041C\x0438\x043D\x0438\x043C\x0430\x043B\x044C\x043D\x044B\x0439\x0020\x0440\x0435\x0436\x0438\x043C",
    ...
    /* ukr */
    {
        ...
        L"\x0412\x0438\x0432\x0456\x0434: \x041C\x0456\x043D\x0456\x043C\x0430\x043B\x044C\x043D\x0438\x0439\x0020\x0440\x0435\x0436\x0438\x043C",
...
void qsearchSetFindAllSettDlgLang(HWND hDlg)
{
    ...
    static const wchar_t* szFindAllOutputMinimalModeW[INLNG_COUNT] = {
        /* eng */
        L"Minimal mode",
        /* rus */
        L"\x041C\x0438\x043D\x0438\x043C\x0430\x043B\x044C\x043D\x044B\x0439\x0020\x0440\x0435\x0436\x0438\x043C",
        /* ukr */
        L"\x041C\x0456\x043D\x0456\x043C\x0430\x043B\x044C\x043D\x0438\x0439\x0020\x0440\x0435\x0436\x0438\x043C"
    };
    ...
    SetWindowTextW( GetDlgItem(hDlg, IDC_CH_FA_MINIMALMODE), szFindAllOutputMinimalModeW[uInternalLng] );
