...
const char*    CSZ_OPTIONS[OPT_TOTALCOUNT] = {
  ...
  /*  3 */  "srch_use_regexp",
  /*  4 */  "srch_regexp_dot_newline",
  /*  5 */  "srch_pickup_selection",
  /*  6 */  "srch_selfind_pickup",
  /*  7 */  "srch_stop_eof",
  /*  8 */  "srch_wnd_dockedtop",
  /*  9 */  "edit_focus_selectall",
  /* 10 */  "catch_main_f3",
  /* 11 */  "catch_main_esc",
...
const wchar_t* CWSZ_OPTIONS[OPT_TOTALCOUNT] = {
  ...
  /*  3 */  L"srch_use_regexp",
  /*  4 */  L"srch_regexp_dot_newline",
  /*  5 */  L"srch_pickup_selection",
  /*  6 */  L"srch_selfind_pickup",
  /*  7 */  L"srch_stop_eof",
  /*  8 */  L"srch_wnd_dockedtop",
  /*  9 */  L"edit_focus_selectall",
  /* 10 */  L"catch_main_f3",
  /* 11 */  L"catch_main_esc",
